...
import './../Components/TaxiBillStyle.css';
...
const TaxiBill = () => {
    ...
    return (
        <>
            {/* <!-------------------- page 1 -------------------------> */}
            <div id="page1">
                <img src="./images/flight.PNG" height="20%" width="15%" align="left" id="img1" />
                <img src="./images/train.PNG" height="20%" width="15%" align="right" id="img1" />
                <h1 id="h1">R S TOURS & TRAVELS</h1>
                <h2>E-227 SECTOR-F LDA COLONY KANPUR ROAD,LUCKNOW</h2>
                <h2>
            ...
            {/* <!-- ------------ page 5 --------------------- --> */}
            <div id="page5">
                <img src="./images/sig.png" align="left" id="imgsig" />
            </div>
